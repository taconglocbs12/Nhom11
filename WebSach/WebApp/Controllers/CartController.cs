...
namespace WebApp.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public ActionResult Payment(FormCollection f)
        {
            ...
            hd.DaGiao = false;
            DatHang d  = service.ThemDonDathang(int.Parse(hd.KhachHangID.ToString()), hd.TenKhachHang, hd.DiaDiem, hd.NgayDatHang, Double.Parse(hd.TriGia.ToString()), hd.DaGiao);
